...
public class transform {
    public static void main (String [] args) throws IOException {
        ...
        //BufferedReader f = new BufferedReader(new FileReader("/Users/alex/IdeaProjects/USACO stuff/src/Chapter_1.transform.in"));
        BufferedReader f = new BufferedReader(new FileReader("Chapter_1.transform.in"));

        // input file name goes above
        //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("/Users/alex/IdeaProjects/USACO stuff/src/Chapter_1.transform.out")));
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Chapter_1.transform.out")));
